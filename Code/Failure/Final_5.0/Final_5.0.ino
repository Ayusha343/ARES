...
String tagID = "";
String s1;
float AcX,AcY,AcZ,GyX,GyY,GyZ,beatAvg,x,dx,dy,dz,dx1,dy1,dz1,dgx,dgy,dgz,dgx1,dgy1,dgz1,db1,db,AA,AB,AC,AD,AE,AF,AG,AH,AI,BPM1,Tmp,tf,spo2;
bool accident,abnormal;
float AcD = 11; //change in value of AC
